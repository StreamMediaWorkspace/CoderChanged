...
class TutorialManager(object):
    ...
    def get_object(self, object_id):
        ...
        elif object_id == "dockCoderContents":
            return self.win.dockCoderContents
    ...
    def exit_manager(self):
        ...
        try:
            ...
            self.win.dockCoder.visibilityChanged.disconnect()
        except:
    ...
    def __init__(self, win):
        ...
        self.win.dockCoder.visibilityChanged.connect(functools.partial(self.process, "dockCoder"))
