	...
	$scope.project = {
		...
		cuts: [
	  	...
	  	layers : [
			...
			//{id: '2', name: 'name3', number:2, y:0, label: '', lock: false},
			//{id: '3', name: 'name4', number:3, y:0, label: '', lock: false},
			//{id: '4', name: 'name5', number:4, y:0, label: '', lock: false}
			 ],
	    selected_layers: [],
	  	markers : [],
              // [
...
// ############ DEBUG STUFFS ################## //
 ...
 $scope.ToggleDebug = function() {
  ...
  $scope.GetSelectedLayers = function() {
	return $scope.project.selected_layers.join(',');
  }

  $scope.OnSelectLayer = function(e, layer_id) {
	var selected_layers = $scope.project.selected_layers;
